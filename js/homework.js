...
console.log(Peter > Jim ? true + " -Peter has more money" : false +" -Peter has less money")
...
console.log(firstFlock >= secondFlock ? true + " -First flock is larger" : false + " -Second flock is larger")